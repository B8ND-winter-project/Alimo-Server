...
public class SignInController {
    ...
    public ResponseData<Token> signInWithDodam(
            @RequestBody @Valid DAuthSignInRequest request
    ){
        return ResponseData.of(HttpStatus.OK, "login success", signInUseCase.dAuthSignIn(request));
    }

    @PostMapping
    public ResponseData<Token> signInParent(
